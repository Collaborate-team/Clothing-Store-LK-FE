        ...
        <div className="sm:col-span-3 lg:col-span-1 lg:pr-[60px] sm:pb-8 sm:border-b sm:border-[rgba(200,185,154,0.15)] lg:pb-0 lg:border-b-0 flex flex-col items-center sm:items-start">
          ...
          <div className="flex gap-4 sm:gap-5">
            ...
            <a
              ...
              className="w-[34px] h-[34px] border border-[rgba(200,185,154,0.3)] flex items-center justify-center text-[#c8b99a] hover:border-[#c8b99a] hover:bg-[rgba(200,185,154,0.08)] transition-all cursor-pointer"
            >
        ...
        <div className="flex flex-wrap justify-center sm:justify-end gap-2 sm:gap-2.5 items-center order-2 sm:order-3">
          <PayBadge title="Visa">
            <svg width="46" height="16" viewBox="0 0 46 16" fill="none">
              <path d="M18.1 0.5L15.1 15.5H18.6L21.6 0.5H18.1Z" fill="#c8b99a" />
              <path d="M30.7 0.8C30 0.5 28.9 0.2 27.5 0.2C24 0.2 21.5 2.1 21.5 4.8C21.5 6.8 23.3 7.9 24.7 8.6C26.1 9.3 26.6 9.7 26.6 10.3C26.6 11.2 25.5 11.6 24.5 11.6C23.1 11.6 22.3 11.4 21.1 10.8L20.6 10.6L20.1 13.8C20.9 14.2 22.4 14.5 24 14.5C27.7 14.5 30.2 12.6 30.2 9.7C30.2 8.1 29.2 6.9 27.1 5.9C25.8 5.2 25.1 4.8 25.1 4.2C25.1 3.6 25.8 3 27.1 3C28.2 3 29 3.2 29.7 3.5L30 3.7L30.7 0.8Z" fill="#c8b99a" />
              <path d="M35.4 10.2C35.7 9.3 36.9 6.1 36.9 6.1C36.9 6.1 37.2 5.3 37.4 4.8L37.6 6C37.6 6 38.3 9.4 38.5 10.2H35.4ZM39.6 0.5H36.9C36.1 0.5 35.5 0.7 35.1 1.5L29.8 15.5H33.5L34.3 13.1H38.8L39.3 15.5H42.6L39.6 0.5Z" fill="#c8b99a" />
              <path d="M14.5 0.5L11 10.4L10.6 8.4C9.9 6.3 8 4 5.8 2.8L9 15.5H12.8L18.3 0.5H14.5Z" fill="#c8b99a" />
              <path d="M7.8 0.5H2.1L2 0.8C6.5 1.9 9.5 4.6 10.6 8.4L9.4 1.5C9.2 0.8 8.6 0.5 7.8 0.5Z" fill="#c8b99a" />
            </svg>
          </PayBadge>
          <PayBadge title="Mastercard">
            <svg width="36" height="22" viewBox="0 0 36 22" fill="none">
              <circle cx="13" cy="11" r="10" fill="#c8b99a" opacity="0.7" />
              <circle cx="23" cy="11" r="10" fill="#8b6f4e" opacity="0.7" />
              <path d="M18 4.3C19.9 5.7 21.2 7.7 21.2 11C21.2 14.3 19.9 16.3 18 17.7C16.1 16.3 14.8 14.3 14.8 11C14.8 7.7 16.1 5.7 18 4.3Z" fill="#c8b99a" opacity="0.9" />
            </svg>
          </PayBadge>
          <PayBadge title="PayPal">
            <svg width="52" height="14" viewBox="0 0 52 14" fill="none">
              ...
              <path d="M20.5 5H18.5C18.3 5 18.1 5.1 18.1 5.3L18 5.9L17.8 5.6C17.3 4.9 16.2 4.7 15.1 4.7C12.6 4.7 10.5 6.6 10.1 9.2C9.9 10.5 10.2 11.7 10.9 12.5C11.5 13.2 12.5 13.5 13.6 13.5C15.6 13.5 16.7 12.3 16.7 12.3L16.6 12.9C16.6 13.1 16.7 13.3 16.9 13.3H18.7C19 13.3 19.2 13.1 19.3 12.8L20.4 5.4C20.5 5.2 20.7 5 20.5 5ZM17.2 9.3C17 10.5 16.1 11.4 14.8 11.4C14.2 11.4 13.7 11.2 13.4 10.8C13.1 10.4 13 9.9 13.1 9.3C13.3 8.1 14.3 7.2 15.5 7.2C16.1 7.2 16.6 7.4 16.9 7.8C17.2 8.2 17.3 8.7 17.2 9.3Z" fill="#c8b99a" />
              <path d="M30.4 5H28.3C28.1 5 27.9 5.1 27.8 5.3L25.3 9.1L24.2 5.4C24.1 5.1 23.9 5 23.6 5H21.5C21.3 5 21.1 5.2 21.2 5.4L23.3 11.6L21.3 14.4C21.2 14.7 21.3 15 21.6 15H23.7C23.9 15 24.1 14.9 24.2 14.7L30.7 5.6C30.8 5.3 30.7 5 30.4 5Z" fill="#c8b99a" />
              <path d="M37.5 1H33.5C33.2 1 33 1.2 32.9 1.5L31 12.5C31 12.7 31.1 12.9 31.3 12.9H33.5C33.7 12.9 33.9 12.7 33.9 12.5L34.4 9.4C34.5 9.1 34.7 8.9 35 8.9H36.4C39.2 8.9 40.8 7.5 41.2 4.9C41.4 3.7 41.2 2.8 40.7 2.2C40.1 1.5 39 1 37.5 1ZM38 5C37.8 6.3 36.8 6.3 35.8 6.3H35.2L35.7 3.4C35.7 3.2 35.9 3.1 36.1 3.1H36.4C37.1 3.1 37.7 3.1 38.1 3.5C38.2 3.8 38.2 4.3 38 5Z" fill="#8b6f4e" />
            </svg>
          </PayBadge>
          <PayBadge title="Klarna">
            <svg width="44" height="14" viewBox="0 0 44 14" fill="none">
              <path d="M2 1H4.8V13H2V1Z" fill="#c8b99a" />
              <path d="M13.5 1H10.6C10.6 3.4 9.5 5.5 7.7 6.9L6.8 7.6L11 13H14.4L10.5 7.9C12.3 6.3 13.5 4 13.5 1Z" fill="#c8b99a" />
              <path d="M16.5 13H19.2V1H16.5V13Z" fill="#c8b99a" />
              <path d="M28.5 5.2C27.7 4.6 26.7 4.3 25.5 4.3C22.6 4.3 20.3 6.5 20.3 9.3C20.3 12.1 22.6 14.3 25.5 14.3C26.7 14.3 27.7 13.9 28.5 13.4V13H31V4.6H28.5V5.2ZM25.7 11.7C24.1 11.7 22.9 10.6 22.9 9.2C22.9 7.8 24.1 6.7 25.7 6.7C27.3 6.7 28.4 7.8 28.4 9.2C28.4 10.6 27.3 11.7 25.7 11.7Z" fill="#c8b99a" />
              <path d="M36 5.8V4.6H33.4V13H36V9.2C36 7.8 37.5 7.1 38.6 7.1H38.6V4.5C37.5 4.5 36.6 5 36 5.8Z" fill="#c8b99a" />
              <path d="M41 11.3C40.1 11.3 39.4 12 39.4 12.9C39.4 13.7 40.1 14.4 41 14.4C41.9 14.4 42.6 13.7 42.6 12.9C42.6 12 41.9 11.3 41 11.3Z" fill="#8b6f4e" />
            </svg>
          </PayBadge>
        </div>
      </div>
