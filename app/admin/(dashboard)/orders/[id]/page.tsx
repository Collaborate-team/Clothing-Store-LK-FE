...
import { fetchOrderById, updateOrderStatus } from '@/lib/api-service';
                  ...
                  <table className="w-full text-left">
                     <thead>
                        <tr className="bg-black/[0.02] border-b border-black/5">
                           ...
                           <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-widest text-black/40">Product ID</th>
                           <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-widest text-black/40">Quantity</th>
                           ...
                           <tr key={i} className="hover:bg-black/[0.01]">
                              <td className="px-8 py-5">
                                 <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[11px] font-bold uppercase text-black">Product #{item.productId}</span>
                                 </div>
                              </td>
                              <td className="px-8 py-5 text-[11px] text-black">{item.productId}</td>
                              <td className="px-8 py-5 text-[11px] font-bold text-black tracking-widest">{item.quantity} PCS</td>
                              <td className="px-8 py-5 text-right text-[11px] font-bold text-black">Calculation Pending</td>
                           </tr>
                        ))}
                     </tbody>
                  </table>
            ...
            <div className="bg-black text-white p-8 rounded-sm shadow-2xl relative overflow-hidden">
               ...
               <div className="relative z-10 space-y-8">
                  <div>
                     ...
                     <p className="text-sm font-bold uppercase">{order.paymentMethod.replace(/_/g, ' ')}</p>
                  </div>
